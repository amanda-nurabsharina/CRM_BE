...
func getBridgeCandidates() []string {
	...
	candidates = append(candidates,
		...
		"http://invitation-crm-wa-bridge:8001",
		"http://invitation_crm-wa-bridge:8001",
		"http://invitation-crm-wa-bridge:3001",
		"http://invitation_crm-wa-bridge:3001",
		"http://wa-bridge:8001",
		"http://wa-bridge:3001",
		"http://poc_crm_wa_bridge:8001",
		"http://poc_crm_wa_bridge:3001",
		"http://invitation-poc_crm_wa_bridge:8001",
		"http://invitation_poc_crm_wa_bridge:8001",
		"http://localhost:3001",
		"http://127.0.0.1:3001",
	)
	return candidates
